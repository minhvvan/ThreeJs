...
material.color = new THREE.Color(292929)
...
pointLight2.position.set(-1.1,1.1,-0.67)
...
const pointLight3 = new THREE.PointLight(0xa6bc3, 0.1)
pointLight3.position.set(1.13,-1.1,-0.67)
...
const upadteSphere = (event) => {
    sphere.position.y = window.scrollY * 0.001
}

window.addEventListener('scroll', upadteSphere)
