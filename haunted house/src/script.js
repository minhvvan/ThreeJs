...
const doorAmbientOcclusionMap = textureLoader.load('textures/door/ambientOcclusion.jpg')
...
for (let i = 0; i < 50 ; i++) {
    ...
    grave.scale.y = 0.8 + Math.random() / 2
...
const tick = () =>
{
    ...
    ghost3.position.z = Math.sin(ghost3Angle) * (7 + Math.sin(elapsedTime * 0.74))
